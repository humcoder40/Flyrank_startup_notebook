<style>
  ...
  /* Unique Metadata Badges instead of a Grid */
  .meta-banner {
    display: flex;
    flex-wrap: wrap;
    gap: 1rem;
...
<div class="meta-banner">
  ...
  <span class="meta-badge"><strong>Academic Cohort:</strong> BSCS Semester VII</span>
...
*(Note: Insert `figures/flagged_age_distribution.png` here to visualize the priority queue distribution).*
